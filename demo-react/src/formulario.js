        ...
        return (
            <form>
                <p>
                    ...
                    <input type='text' id='nombre' name='nombre' value={this.state.elemento.nombre} onChange={this.handleChange} required
                    ...
                    <br />
                    <input type='checkbox' id='conflictivo' name='conflictivo' value={this.state.elemento.conflictivo} onChange={this.handleChange} />
